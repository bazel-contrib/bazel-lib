...
COPY_DIRECTORY_INTEGRITY = {
    ...
    "windows_amd64": "sha256-ytdfdmbkB2nHSY5xHUuYiFAJ9MFt+WM0uey25sttnWU=",
}
COPY_TO_DIRECTORY_INTEGRITY = {
    ...
    "windows_amd64": "sha256-H+8EiOxHCTWZ0R3ok+lS0NdYpjwZf+io9BPeo+lA40k=",
}
EXPAND_TEMPLATE_INTEGRITY = {
    ...
    "windows_amd64": "sha256-DUwILblpcJD63turokSFjaQnc71Qj7PunGanL3s6P/o=",
}
