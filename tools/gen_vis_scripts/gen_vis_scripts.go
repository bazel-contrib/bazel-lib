...
func writeVisEscapeSed(w io.Writer) {
	fmt.Fprintln(w, strings.TrimSpace(`
# Code generated by gen_vis_scripts. DO NOT EDIT.
#
# Replace most bytes with their octal escape sequences.
# Backslashes and newlines remain in place to preserve newline-delimited records
# while allowing upstream producers to include newlines in vis-encoded content.
	`))
	fmt.Fprintln(w, "")
