...
def _expand_template_toolchains_repo_impl(rctx):
    ...
    starlark_content = """# @generated by @bazel_lib//lib/private:expand_template_toolchain.bzl

# Forward all the providers
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@bazel_lib//lib:expand_template_toolchain_type"]
    return [
        toolchain_info,
...
"""
    ...
    build_content = """# @generated by @bazel_lib//lib/private:expand_template_toolchain.bzl
#
...
def _expand_template_platform_repo_impl(rctx):
    ...
    build_content = """# @generated by @bazel_lib//lib/private:expand_template_toolchain.bzl
load("@bazel_lib//lib/private:expand_template_toolchain.bzl", "expand_template_toolchain")
exports_files(["{0}"])
