...
def _copy_to_directory_toolchains_repo_impl(rctx):
    ...
    starlark_content = """# @generated by @bazel_lib//lib/private:copy_to_directory_toolchain.bzl

# Forward all the providers
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@bazel_lib//lib:copy_to_directory_toolchain_type"]
    return [
        toolchain_info,
...
"""
    ...
    build_content = """# @generated by @bazel_lib//lib/private:copy_to_directory_toolchain.bzl
#
...
def _copy_to_directory_platform_repo_impl(rctx):
    ...
    build_content = """# @generated by @bazel_lib//lib/private:copy_to_directory_toolchain.bzl
load("@bazel_lib//lib/private:copy_to_directory_toolchain.bzl", "copy_to_directory_toolchain")
exports_files(["{0}"])
