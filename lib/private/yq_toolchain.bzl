...
def _yq_toolchains_repo_impl(rctx):
    ...
    starlark_content = """# @generated by @bazel_lib//lib/private:yq_toolchain.bzl

# Forward all the providers
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@bazel_lib//lib:yq_toolchain_type"]
    return [
        toolchain_info,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@bazel_lib//lib:yq_toolchain_type"],
)
"""
    rctx.file("defs.bzl", starlark_content)

    build_content = """# @generated by @bazel_lib//lib/private:yq_toolchain.bzl
#
...
toolchain(
    ...
    toolchain_type = "@bazel_lib//lib:yq_toolchain_type",
)
""".format(
            platform = platform,
...
def _yq_platform_repo_impl(rctx):
    ...
    build_content = """# @generated by @bazel_lib//lib/private:yq_toolchain.bzl
load("@bazel_lib//lib/private:yq_toolchain.bzl", "yq_toolchain")
exports_files(["{0}"])
...
def _yq_host_alias_repo(rctx):
    ...
    # Base BUILD file for this repository
    rctx.file("BUILD.bazel", """# @generated by @bazel_lib//lib/private:yq_toolchain.bzl
