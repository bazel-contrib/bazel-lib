...
# @generated by @bazel_lib//lib/private:tar_toolchain.bzl

load("@bazel_lib//lib/private:tar_toolchain.bzl", "tar_toolchain")
...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@bazel_lib//lib:tar_toolchain_type"]
    return [
        toolchain_info,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@bazel_lib//lib:tar_toolchain_type"],
)
"""
    rctx.file("defs.bzl", starlark_content)

    build_content = """# @generated by @bazel_lib//lib/private:tar_toolchain.bzl
...
toolchain(
    ...
    toolchain_type = "@bazel_lib//lib:tar_toolchain_type",
)
""".format(
            platform = platform,
