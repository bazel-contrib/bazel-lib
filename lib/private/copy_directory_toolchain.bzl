...
def _copy_directory_toolchains_repo_impl(rctx):
    ...
    starlark_content = """# @generated by @bazel_lib//lib/private:copy_directory_toolchain.bzl

# Forward all the providers
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@bazel_lib//lib:copy_directory_toolchain_type"]
    return [
        toolchain_info,
...
"""
    ...
    build_content = """# @generated by @bazel_lib//lib/private:copy_directory_toolchain.bzl
#
