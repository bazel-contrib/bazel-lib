...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@bazel_lib//lib:jq_toolchain_type"]
    return [
        toolchain_info,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@bazel_lib//lib:jq_toolchain_type"],
)
"""
...
toolchain(
    ...
    toolchain_type = "@bazel_lib//lib:jq_toolchain_type",
)
""".format(
            platform = platform,
...
def _jq_platform_repo_impl(rctx):
    ...
    build_content = """# @generated by @bazel_lib//lib/private:jq_toolchain.bzl
load("@bazel_lib//lib/private:jq_toolchain.bzl", "jq_toolchain")
exports_files(["{0}"])
